...
{
    public partial class FormTitration : LibraryBasicForm.FormBaseEmpty
    {
        #region Attributes
        ...
        private void ucSignTitration_OnSign(bool login)
        {
            if (login)
            {
                /// --- si se han completado registros para el usuario actual
                /// firmarlos y refrescar la trazabilidad
