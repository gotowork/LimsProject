...
namespace LimsProject
{
    ...
    public partial class UcSolInterm : UserControl
    {
        ...
        void InitHeader()
        {
            ...
            tbConcentSolInterm1.Text = template_method_aa.Std_flag_sol_intermedia1 == true ? template_method_aa.Std_concentration_sol1.ToString() : "";
            tbConcentSolInterm2.Text = template_method_aa.Std_flag_sol_intermedia2 == true ? template_method_aa.Std_concentration_sol2.ToString() : "";
        ...
        {                        
            ...
            cbMedium.EditValue = null;
            cbModif.EditValue = null;
            tbConcentSolInterm1.Text = "";
            tbConcentSolInterm2.Text = "";
            tbUnidInterm1.Text = "";
            tbUnidInterm2.Text = "";
        }
